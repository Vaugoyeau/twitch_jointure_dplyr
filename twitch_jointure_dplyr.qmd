...
ncol(info_departement) + ncol(temperature) - 1 == ncol(jointure_totale)

# vérification du nombre de lignes
nrow(temperature) == nrow(jointure_totale)
...
# vérification  
identical(jointure_interne, jointure_a_droite)
```
